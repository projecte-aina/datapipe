...
# source: vosk_stt_grpc/stt_service.proto
...
_RECOGNITIONSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='max_alternatives', full_name='vosk.stt.v1.RecognitionSpec.max_alternatives', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='enable_word_time_offsets', full_name='vosk.stt.v1.RecognitionSpec.enable_word_time_offsets', index=9,
...
StreamingRecognitionRequest = _reflection.GeneratedProtocolMessageType('StreamingRecognitionRequest', (_message.Message,), {
  ...
  '__module__' : 'vosk_stt_grpc.stt_service_pb2'
